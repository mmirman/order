...
As \citet{barendregt1991introduction} points out, the common type theories with only functions 
can be recast as pure type systems by choice of axioms.  
...
\citet{geuvers1991modular} proved subject reduction for any calculus on the $\lambda$ cube.
This property can be proved syntactically by induction on the structure of the typing derivation 
and there exist Elf and Agda verified proofs of this property.  
